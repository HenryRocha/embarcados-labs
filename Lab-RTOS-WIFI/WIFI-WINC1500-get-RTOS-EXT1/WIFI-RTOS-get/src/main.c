...
void get_path(char *buffer, char endpoint[]) {
    // Formata o buffer dado com o endpoint que deseja mandar o GET.
        ...
        case M2M_WIFI_RESP_GET_SYS_TIME:
            /*Initial first callback will be provided by the WINC itself on the first communication with NTP */
            {
                ...
                printf("socket_cb: Year: %d, Month: %d, The GMT time is %u:%02u:%02u\r\n", strSysTime_now->u16Year,
                       strSysTime_now->u8Month, strSysTime_now->u8Hour, /* hour (86400 equals secs per day) */
